...
var _CaptionTransitions = [];
            ...
            var options = {
                ...
                //$SlideHeight: 656,                                //[Optional] Height of every slide in pixels, default value is height of 'slides' container
            ...
            function ScaleSlider() {
                ...
                if (bodyWidth){
                    jssor_slider1.$ScaleWidth(Math.min(bodyWidth,$("#marcoGeneral").width()-110));
                    jssor_slider1.$SlideHeight(Math.min(bodyHeight,$("#marcoGeneral").height()));

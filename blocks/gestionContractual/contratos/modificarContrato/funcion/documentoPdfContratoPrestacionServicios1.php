...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------               
       ...
       // $ordenadorInfoExtra = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");
        ...
        if($contrato['fecha_registro']<'2017-06-02'){
            $cadenaSql = $this->miSql->getCadenaSql('consultaPlantilla', array('tipo_contrato' => $contrato['tipo_contrato'], 'tipo_plantilla' => 'plantillaJuridica'));
            $plantilla = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");
        }
        else{
           $cadenaSql = $this->miSql->getCadenaSql('consultaPlantilla', array('tipo_contrato' => $contrato['tipo_contrato'], 'tipo_plantilla' => 'plantillaJuridica2'));
           $plantilla = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");   
        }

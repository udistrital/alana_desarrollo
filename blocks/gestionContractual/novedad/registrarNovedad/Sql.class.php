    ...
    function getCadenaSql($tipo, $variable = "") {
        ...
        switch ($tipo) {
            ...
            case 'buscar_contrato' :
                ...
                $cadenaSql .= " AND cg.numero_contrato = ce.numero_contrato and cg.vigencia = ce.vigencia and ce.estado = ec.id AND tpc.id_grupo_tipo_contrato = 2 AND ec.id =4 AND cg.vigencia = '" . $variable['vigencia_curso'] . "' ";
            ...
            case "buscar_numero_orden" :
                ...
                $cadenaSql = " 	SELECT 	cs.numero_contrato_suscrito ||'-'|| cs.vigencia as value, cs.numero_contrato_suscrito ||'-'||cs.vigencia as orden ";
                ...
                $cadenaSql .= " AND cg.numero_contrato = cs.numero_contrato and cg.vigencia = cs.vigencia ";
                $cadenaSql .= " AND ce.fecha_registro = (SELECT MAX(cee.fecha_registro) from contrato_estado cee where cg.numero_contrato = cee.numero_contrato and  cg.vigencia = cee.vigencia) ";
                $cadenaSql .= " and cg.tipologia_contrato ='" . $variable['tipo_contrato'] . "' AND ec.id = 4 ;";
            ...
            case "consultarNovedadesContrato" :
                ...
                $cadenaSql.=" AND vigencia=$variable[1] and nc.tipo_novedad <> 218 and nc.tipo_novedad <> 257 and nc.tipo_novedad <> 224 and nc.tipo_novedad <> 216 and  nc.tipo_novedad <> 217 and  nc.tipo_novedad <> 234;";
                break;
            ...
            case "consultarContratoGeneral" :
                ...
                $cadenaSql = "SELECT DISTINCT  cg.clase_contratista, p.descripcion, cg.tipologia_contrato, cg.numero_contrato, cg.vigencia, cg.fecha_registro, cg.contratista  as proveedor,"
                        . "  cg.numero_solicitud_necesidad,cg.numero_cdp, ec.nombre_estado, ce.fecha_registro as fecha_registro_estado, cg.convenio, cs.numero_contrato_suscrito,tpc.tipo_contrato ";
                ...
                $cadenaSql .= "AND (ec.id = 4 or ec.id = 2) AND cg.vigencia = " . $variable['vigencia_curso'] . " AND cg.clase_contratista is not null ";
            ...
            case "consultarAdcionesPresupuesto" :
                ...
                $cadenaSql .= " FROM adicion a , novedad_contractual nc    ";
                $cadenaSql .= " WHERE a.id = nc.id AND numero_contrato = '$variable[0]' AND vigencia = $variable[1] ";
                $cadenaSql .= " AND tipo_adicion = 248 Order by nc.id ASC;";
                break;
            ...
            case "ConsultaSupervisorNovedad" :
                $cadenaSql = "   SELECT documento ||' - '|| nombre ";
                $cadenaSql .= "  FROM supervisor_contrato WHERE id = $variable ";
                break;

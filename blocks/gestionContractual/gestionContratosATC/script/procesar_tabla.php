...
<script type='text/javascript'>
    ...
    $(function () {
        ...
        $('#tablaContratosATC').ready(function () {

            var table = $('#tablaContratosATC').dataTable({
                "language": {
    ...
    $(function () {
        ...
        $('#tablaContratosATCLiquidar').ready(function () {

            var table = $('#tablaContratosATCLiquidar').dataTable({
                "language": {
                    "sProcessing": "Procesando...",
                    "sLengthMenu": "Mostrar _MENU_ registros",
                    "sZeroRecords": "No se encontraron resultados",

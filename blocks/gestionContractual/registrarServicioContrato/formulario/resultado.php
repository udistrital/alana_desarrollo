...
class registrarForm {
    ...
    function miForm() {
        ...
        if (isset($_REQUEST ['vigencia_contrato']) && $_REQUEST ['vigencia_contrato'] != '' && strpos($_REQUEST ['vigencia_contrato'], "-") != false) {
            $numero_contrato = explode(" - ", $_REQUEST ['vigencia_contrato']);
            $vigencia = str_replace("(", "", $numero_contrato[1]);
        ...
        $arreglo = array(
            ...
            'numero_contrato' => $numero_contrato[0],
            'vigencia' => $vigencia,
        ...
        if ($contratos) {
            ...
            for ($i = 0; $i < count($contratos); $i ++) {
                ...
                $variable .= "&opcion=cargarServicio";
                $variable .= "&arreglo=" . $arreglo;
                $variable .= "&numero_contrato=" . $contratos [$i] ['numero_contrato'];
                $variable .= "&vigencia=" . $contratos [$i] ['vigencia'];
                $variable .= "&usuario=" . $_REQUEST['usuario'];
                $variable .= "&mensaje_titulo=" . $contratos [$i] ['tipo_contrato'] . " <br>CONSECUTIVO DE ELABORACIÓN - VIGENCIA     : " . $contratos [$i] ['numero_contrato'] . " -- " . $contratos [$i] ['vigencia'];
                $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);
                ...
                $mostrarHtml .= "<td><center>" .  $contratos [$i]['vigencia'] . "</center></td>
                ...
                $mostrarHtml .="<td><center>" . $contratos [$i] ['sededependencia'] . "</center></td>";
                $mostrarHtml .= "<td><center>" . $contratos [$i] ['nombre_estado'] . "</center></td>
                    <td><center>
                    	<a href='" . $variable . "'>

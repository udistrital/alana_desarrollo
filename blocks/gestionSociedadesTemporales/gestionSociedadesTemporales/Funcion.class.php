...
class Funcion {
    ...
    function registrarSociedad() {
        include_once ($this->ruta . "funcion/registrarSociedad.php");
    }

    function editarSociedad() {
        include_once ($this->ruta . "funcion/editarSociedad.php");
    }

    function inactivarSociedad() {
    ...
    function action() {
        ...
        if (isset($_REQUEST ['procesarAjax'])) {
            ...
            switch ($_REQUEST ['opcion']) {
                ...
                case 'inactivarSociedad' :
                    $this->inactivarSociedad();
                    break;
            }
        }
    }

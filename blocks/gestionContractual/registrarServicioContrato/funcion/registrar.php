...
namespace gestionContractual\registrarServicioContrato\funcion;

use gestionContractual\registrarServicioContrato\funcion\redireccion;
    ...
    function procesarFormulario() {
        ...
        switch ($_REQUEST ['tipo_registro']) {
            ...
            case '1' :
                ...
                $resultado = $esteRecursoDB->ejecutarAcceso($cadenaSql, "acceso",$datosServicio,"registrarservicio");

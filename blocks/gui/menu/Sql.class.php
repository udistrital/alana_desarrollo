    ...
    function getCadenaSql($tipo, $variable = "") {
        ...
        switch ($tipo) {
            ...
            case "datosUsuario":
                ...
                $cadena_sql.=" imagen ,";
                $cadena_sql.=" estado ";
                $cadena_sql.=" FROM frame_work." . $prefijo . "usuario";
            ...
            case "datosMenus":
                ...
                $cadena_sql.=" FROM frame_work." . $prefijo . "menu mn";
                $cadena_sql.=" INNER JOIN frame_work." . $prefijo . "grupo_menu gru ";
                $cadena_sql.="      ON mn.id_menu=gru.id_menu ";
                $cadena_sql.="      AND gru.estado=1 ";
                $cadena_sql.="      AND mn.estado=1";
                $cadena_sql.=" INNER JOIN frame_work." . $prefijo . "servicio serv";
                $cadena_sql.="      ON serv.id_grupo=gru.id_grupo";
                $cadena_sql.="      AND serv.estado=1";
                $cadena_sql.=" INNER JOIN frame_work." . $prefijo . "enlace enl ";
            ...
            case "RolesInactivos" :
                ...
                $cadena_sql.= " FROM frame_work." . $prefijo . "usuario_subsistema perfil ";
                $cadena_sql.= " INNER JOIN frame_work." . $prefijo . "rol rol  ";

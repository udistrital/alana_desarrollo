...
class registrarForm {
    ...
    function miForm() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Consulta Sociedades Temporales";
        echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
            
            
            $esteCampo = 'identificacion_sociedad';
            $atributos ['id'] = $esteCampo;
            $atributos ['nombre'] = $esteCampo;
            $atributos ['tipo'] = 'text';
            $atributos ['estilo'] = 'jqueryui';
            ...
            $atributos ['validar'] = '';
            $atributos ['textoFondo'] = 'Digite el numero de identificación de la sociedad';
            ...
            $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("tipo_sociedad");
            $tab ++;
            $atributos = array_merge($atributos, $atributosGlobales);
   ...
   // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
        ...
        $valorCodificado .= "&opcion=ConsultarSociedades";

    ...
    function almacenarInfoTemporal(pasoActual, pasoNuevo) {
        if (pasoActual == 0) {
            ...
            if (document.getElementById("<?php echo $this->campoSeguro('numero_contrato') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('numero_contrato') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('tipo_identificacion') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('tipo_identificacion') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('numero_identificacion') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('numero_identificacion') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('digito_verificacion') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('digito_verificacion') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('tipo_persona') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('tipo_persona') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('primer_nombre') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('primer_nombre') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('segundo_nombre') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('segundo_nombre') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('primer_apellido') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('primer_apellido') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('segundo_apellido') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('segundo_apellido') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('genero') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('genero') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('nacionalidad') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('nacionalidad') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('direccion') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('direccion') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('telefono') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('telefono') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('correo') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('correo') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('perfil') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('perfil') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('profesion') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('profesion') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('especialidad') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('especialidad') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('tipo_cuenta') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('tipo_cuenta') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('numero_cuenta') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('numero_cuenta') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('entidad_bancaria') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('entidad_bancaria') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('tipo_configuracion') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('tipo_configuracion') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('clase_contratista') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('clase_contratista') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('identificacion_clase_contratista') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('identificacion_clase_contratista') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('digito_verificacion_clase_contratista') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('digito_verificacion_clase_contratista') ?>").value);
            }
            if (document.getElementById("<?php echo $this->campoSeguro('porcentaje_clase_contratista') ?>").value != "") {
                InfoPaso0.push(document.getElementById("<?php echo $this->campoSeguro('porcentaje_clase_contratista') ?>").value);
            }

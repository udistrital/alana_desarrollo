...
class registrarForm {
    ...
    function miForm() {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultarContratoGeneral', $arreglo);
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Contratos en Ejecución";
        ...
        if ($contratos) {
            ...
            for ($i = 0; $i < count($contratos); $i ++) {
                ...
                $variable .= "&numero_contrato_suscrito=" . $contratos [$i] ['numero_contrato_suscrito'];
                $variable .= "&vigencia=" . $contratos [$i] ['vigencia'];
                $variable .= "&id_contratista=" . $contratos [$i] ['proveedor'];
                $variable .= "&arreglo=" . $arreglo;
                $variable .= "&usuario=" . $_REQUEST ['usuario'];
                $variable .= "&mensaje_titulo= -> Contrato " . $contratos [$i] ['tipo_contrato'] . "  | VIGENCIA:" . $contratos [$i] ['vigencia'] . " | NÚMERO CONTRATO : " . $contratos [$i] ['numero_contrato_suscrito'];
                $variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable, $directorio);
                ...
                $variable_documento .= "&numero_contrato_suscrito=" . $contratos [$i] ['numero_contrato_suscrito'];
                $variable_documento .= "&vigencia=" . $contratos [$i] ['vigencia'];
                $variable_documento .= "&usuario=" . $_REQUEST['usuario'];
                $variable_documento .= "&tipo_contrato=" . $contratos [$i] ['tipo_contrato'];
                $variable_documento .= "&opcion=generarDocumento";
                ...
                $variableDocumentoOtroSi .= "&numero_contrato=" . $contratos [$i] ['numero_contrato'];
                $variableDocumentoOtroSi .= "&numero_contrato_suscrito=" . $contratos [$i] ['numero_contrato_suscrito'];
                $variableDocumentoOtroSi .= "&vigencia=" . $contratos [$i] ['vigencia'];
                ...
                $variableConsultaNoveades .= "&numero_contrato_suscrito=" . $contratos [$i] ['numero_contrato_suscrito'];
                ...
                $variableConsultaNoveades .= "&mensaje_titulo= -> Contrato " . $contratos [$i] ['tipo_contrato'] . "  | VIGENCIA:" . $contratos [$i] ['vigencia'] . " | NÚMERO CONTRATO : " . $contratos [$i] ['numero_contrato_suscrito'];
                ...
                $mostrarHtml .="               <td><center>" . $contratos [$i] ['numero_contrato_suscrito'] . "</center></td>		
                ...
                $mostrarHtml .= "<td><center>" . $contratos [$i] ['fecha_registro'] . "</center></td>

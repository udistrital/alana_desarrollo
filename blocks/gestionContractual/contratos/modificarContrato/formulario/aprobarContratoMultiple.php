...
class registrarForm {
    ...
    function miForm() {
        ...
        echo $this->miFormulario->formulario($atributos); {
            ...
            $atributos ['tipoEtiqueta'] = 'inicio';
            $atributos ["leyenda"] = "Suscripción Multiple de Contratos";
            ...
            if (count($_POST) > 3) {
                ...
                $cadenaSql = $this->miSql->getCadenaSql('consultarFechaMinimaParaSuscribir', array(0 => $rango, 1 => date("Y")));
                ...
                $mensaje = "<p><h3>SUSCRIPCIÓN DE CONTRATOS</h2></p> <br> <p><h4>LOS CONTRATOS REFERIDOS A CONTINUACIÓN: </h3></p> ";
                for ($j = 0; $j < count($datos); $j++) {

                    $mensaje .= "CONSECUTIVO DE ELABORACIÓN: " . $datos[$j]['numero_contrato'] .
                ...
                $mensaje .= "</p><h4>SE SUSCRIBIRÁN Y OBTENDRAN UN NÚMERO ÚNICO DE CONTRATO PARA LA VIGENCIA ACTUAL." . $this->miFormulario->cuadroMensaje($atributos) . "</h4></p>";
                ...
                $mensaje = "No se selecciono ningun contrato.<br>Verifique el proceso realizado e intente de nuevo.";

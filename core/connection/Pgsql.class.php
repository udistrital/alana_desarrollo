...
class Pgsql extends ConectorDb {
	 ...
	 * @name registro_log
	 * @param
	 *        	evento datos parametros nombreAccion
	 * @return void
	 * @access public
	 * @author Stiv Verdugo Marquez
	 *        
	 */
	...
	function ejecutarAcceso($cadena, $tipo = "", $arregloDatos = '', $nombre_accion = '', $numeroRegistros = 0) {
		...
		if (isset ( $esteRegistro ) && $esteRegistro != false) {
			...
			$regitro_invalidos = stristr ( $cadena, 'alana_valor_sesion' );

...
class registrarForm {
    ...
    function miForm() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Gestión Poscontractual";
        ...
        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("vigencias");
        ...
        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("ordenesATC");
        $matrizItems = $DBContractual->ejecutarAcceso($atributos ['cadena_sql'], "busqueda");
        $atributos ['matrizItems'] = $matrizItems;
        ...
        $valorCodificado .= "&opcion=ConsultarOrdenes";

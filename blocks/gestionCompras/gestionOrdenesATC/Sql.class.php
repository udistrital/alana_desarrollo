...
namespace gestionCompras\gestionOrdenesATC;
    ...
    function getCadenaSql($tipo, $variable = "") {
        ...
        switch ($tipo) {
            ...
            case "consultarOrdenGeneral" :
                ...
                $cadenaSql = "SELECT DISTINCT o.id_orden, p.descripcion, o.numero_contrato, o.vigencia, o.fecha_registro, cg.contratista  as proveedor,"
                    . "o.tipo_orden,ec.id as estado_orden,cg.convenio,cg.clase_contratista,tpc.tipo_contrato,"
                        . " se.\"ESF_SEDE\" ||'-'|| dep.\"ESF_DEP_ENCARGADA\" as SedeDependencia, cg.numero_solicitud_necesidad,cg.numero_cdp, ec.nombre_estado, "
                ...
                $cadenaSql .= "AND cg.unidad_ejecutora = " . $variable ['unidad_ejecutora'] . " AND cg.vigencia = " . $variable['vigencia'] . " ";
                $cadenaSql .= "AND o.estado = 'true'  AND ec.id = " . $variable['estado'] . " ";
                ...
                $cadenaSql .= " cg.vigencia,cg.numero_contrato,cg.contratista,ue.id||' - '||ue.nombre as unidad, s.documento ||'-'|| s.nombre as supervisor,  ";
                ...
                $cadenaSql .= " \"dependencia_SIC\" dependencia, contrato_estado ce, estado_contrato ec ";
